...
int main()
{
    ...
    cc_json json = {
        {"id", {true, 2, 99.57}},
        {"age", {{std::string{"张三"}, 18}, {"李四", 19}, {"王五", {{"ID", "21814"}, {"name", "王五"}, {"age", 20}, {"city", "上海"}}}}},
    };
    ...
    cc_json json6 = js::parse(json_file);
    auto t1 = std::chrono::high_resolution_clock::now();
    auto str6 = json6.to_string();
    ...
    std::cout << "byte: " << json_file.size() << "B" << std::endl;
    std::cout << "byte: " << json_file.size() / std::chrono::duration_cast<std::chrono::duration<double>>(end - start).count() << "/s" << std::endl;
    std::cout << "parse: " << std::chrono::duration_cast<std::chrono::duration<double>>(t1 - start).count() << "s" << std::endl;
    std::cout << "to_string: " << std::chrono::duration_cast<std::chrono::duration<double>>(end - t1).count() << "s" << std::endl;
